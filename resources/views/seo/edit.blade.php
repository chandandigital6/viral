...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('seo.update', ['seo' => $seo]) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="property" name="property" value="{{ $seo->property }}">
            </div>
            <div class="form-group">
                <label for="content">content</label>
                <input type="text" class="form-control" id="content" name="content" value="{{ $seo->content }}">
            </div>
            <div class="form-group">
