    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('serviceContent.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control textarea" id="content_1" name="content_1">{{ old('content_1') }}</textarea>
                @error('content_1')
                <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            <div class="form-group">
                ...
                <textarea class="form-control textarea" id="content_2" name="content_2">{{ old('content_2') }}</textarea>
                @error('content_2')
                <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
