                    ...
                    <div class="card-body">
                        <form action="{{route('counter.update',$counter->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="@extends('layouts.aap')
@section('content')
                                            ...
                                            <div class="card-body">
                                                <form action="{{route('counter.update',$counter->id)}}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" id="number" name="number" value="{{$counter->number}}" required>
                                                    </div>
                                                    {{--                            <div class="form-group">--}}
